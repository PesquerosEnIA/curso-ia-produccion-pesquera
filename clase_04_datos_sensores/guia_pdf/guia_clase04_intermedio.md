...
> **Para participantes con base básica de Python** que leen y modifican código. Esta guía
> desarrolla el marco conceptual completo y se acompaña del notebook
> `clase04_datos_intermedio.ipynb` con ejercicios prácticos.
...
1. **Frentes y clorofila.** En el notebook, mové el pico de clorofila de −40°S a −38°S y describí cómo cambia la zona productiva y qué puerto queda mejor posicionado.
2. **Estacionalidad del óptimo térmico.** Filtrá `registros_captura` por estación y recalculá la correlación SST–captura. ¿El agua óptima es la misma en invierno que en verano?
3. **Nueva variable.** Agregá una columna `dist_costa_km` simulada y evaluá su correlación con la captura. ¿Aporta información?
4. **Lectura crítica.** Enumerá tres razones por las que la correlación SST–captura de estos datos sintéticos podría **no** replicarse con datos reales.

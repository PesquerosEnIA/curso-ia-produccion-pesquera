...
\begin{titlepage}
  ...
  \begin{infobox}
    ...
    \begin{tabular}{ll@{\hspace{1.5cm}}ll}
      ...
      \textbf{Carga horaria} & 23\,h (10 clases + 2 charlas)  & \textbf{Edición}   & 2026 \\
...
El curso se organiza en \textbf{10 clases de 2 horas} (20 horas) más \textbf{2 charlas complementarias de 1,5 horas} a cargo del Dr.\ Juan Domingo González (\textbf{23 horas totales}).
...
\medskip
\begin{tcolorbox}[
  enhanced, colback=techgold!5, colframe=techgold!70,
  fonttitle=\bfseries\small\color{white}, coltitle=white,
  attach boxed title to top left={yshift=-2mm, xshift=4mm},
  boxed title style={colback=techgold!80, colframe=techgold!80},
  title={Charlas Complementarias — Dr.\ Juan Domingo González \textit{(Docente Invitado)}},
  left=6pt, right=6pt, top=10pt, bottom=6pt
]
  \textit{2 sesiones · 1,5 horas cada una · 3 horas adicionales}\\[8pt]

  \textbf{Charla A — Acústica Computacional e IA aplicada a la Detección de Cardúmenes}\\
  \textit{SENASA / DIIV-ARA-CONICET / UBA}\\[3pt]
  Modelos computacionales de dispersión acústica para estimación de biomasa de anchoíta (\textit{Engraulis anchoita}) y otras especies pelágicas de la Plataforma Continental Argentina. Aplicaciones de machine learning en el análisis de señales de ecosonda y SONAR. Articulación con los sistemas de monitoreo y gestión del recurso pesquero.\\[8pt]

  \textbf{Charla B — Clustering Robusto y Estadística Computacional aplicada a Datos Pesqueros}\\
  \textit{UBA / Universidad Nacional Guillermo Brown}\\[3pt]
  Métodos de clustering robusto para clasificación de zonas de pesca y análisis de patrones oceanográficos. Paquetes RMBC y ktaucenters (CRAN-R). Detección de valores atípicos en series de captura y datos ambientales.
\end{tcolorbox}
